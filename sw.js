/* Gym Tracker service worker v132 */
const VERSION="v132";
...
const CORE_ASSETS=[
  ...
  "./hotfix-v126.css","./hotfix-v129.css","./hotfix-v130.css","./hotfix-v131.css","./v129-core.js","./v129-detail.js","./v129-cloud.js","./v130-core.js","./v131-core.js","./v132-core.js",
...
self.addEventListener("install",event=>event.waitUntil((async()=>{
  ...
  const critical=["./index.html","./hotfix-v126.css","./hotfix-v129.css","./hotfix-v130.css","./hotfix-v131.css","./v129-core.js","./v129-detail.js","./v129-cloud.js","./v130-core.js","./v131-core.js","./v132-core.js"];
...
async function injectV132(response){
  ...
  html=html.replace(/const VERSION=125;/g,"const VERSION=132;");
  html=html.replace(/class="app-version">v125</g,'class="app-version">v132<');
  if(!html.includes("hotfix-v126.css"))html=html.replace("</head>",'<link rel="stylesheet" href="./hotfix-v126.css?v=132">\n</head>');
  if(!html.includes("hotfix-v129.css"))html=html.replace("</head>",'<link rel="stylesheet" href="./hotfix-v129.css?v=132">\n</head>');
  if(!html.includes("hotfix-v130.css"))html=html.replace("</head>",'<link rel="stylesheet" href="./hotfix-v130.css?v=132">\n</head>');
  if(!html.includes("hotfix-v131.css"))html=html.replace("</head>",'<link rel="stylesheet" href="./hotfix-v131.css?v=132">\n</head>');
  if(!html.includes("v129-core.js"))html=html.replace("</body>",'<script src="./v129-core.js?v=132"></script>\n<script src="./v129-detail.js?v=132"></script>\n<script src="./v129-cloud.js?v=132"></script>\n<script src="./v130-core.js?v=132"></script>\n<script src="./v131-core.js?v=132"></script>\n<script src="./v132-core.js?v=132"></script>\n</body>');
  else if(!html.includes("v130-core.js"))html=html.replace("</body>",'<script src="./v130-core.js?v=132"></script>\n<script src="./v131-core.js?v=132"></script>\n<script src="./v132-core.js?v=132"></script>\n</body>');
  else if(!html.includes("v131-core.js"))html=html.replace("</body>",'<script src="./v131-core.js?v=132"></script>\n<script src="./v132-core.js?v=132"></script>\n</body>');
  else if(!html.includes("v132-core.js"))html=html.replace("</body>",'<script src="./v132-core.js?v=132"></script>\n</body>');
...
async function navigationNetworkFirst(request){
  const cache=await caches.open(CORE_CACHE);
  try{const response=await fetch(request,{cache:"no-store"});if(response.ok)await cache.put("./index.html",response.clone());return injectV132(response)}
  catch(_){const cached=(await cache.match("./index.html"))||(await cache.match("./"));return injectV132(cached)}
}
...
self.addEventListener("notificationclick",event=>{event.notification.close();event.waitUntil((async()=>{const list=await clients.matchAll({type:"window",includeUncontrolled:true});if(list.length){await list[0].focus();return}await clients.openWindow("./?v=132&finishWorkout=1")})())});
